...
import net.bw.onlineshopping.service.CartService;
		...
		if(result!=null) {
			switch(result) {
				case "added":
					...
					break;
				case "unavailable":
					mv.addObject("message", "Product quantity not available!");					
					break;
				case "updated":
					...
					break;
				case "modified":
					mv.addObject("message", "One or more items inside cart have been modified!");
					break;
				case "maximum":
