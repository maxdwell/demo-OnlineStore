package net.bw.onlineshopping.service;
...
import net.bw.onlineshopping.model.UserModel;
import net.bw.shoppingbackend.dao.CartLineDAO;
...
import net.bw.shoppingbackend.dto.CartLine;
...
public class CartService {
	...
	public String manageCartLine(int cartLineId, int count) {
		...
		// checking if the specified quantity is available or not
	...
	public String addCartLine(int productId) {		
		...
		if(cartLine==null) {
			// to add a new cartLine if a new product is getting added
			cartLine = new CartLine();
			Product product = productDAO.get(productId);
			// transfering the product details to cartLine
			...
			// checking if the cartLine has been already reached to maximum count
			if(cartLine.getProductCount() < 3) {
				// to call the manageCartLine method to increase the count
