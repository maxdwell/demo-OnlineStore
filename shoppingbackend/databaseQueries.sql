...
VALUES ('PRDABC123DEFX', 'Samsung s9', 'Samsung', '128gb Storage: 4gb ram: 1.7Adreno octacore processor: 12.0MP Camera', 348,000, 5, true, 1, 3, 0, 0 );
INSERT INTO product (code, name, brand, description, unit_price, quantity, is_active, category_id, supplier_id, purchases, views)
VALUES ('PRDDEF123DEFX', 'Samsung s7', 'samsung', '64gb Storage: 3gb ram: 1.4Adreno octacore processor: 10.0MP Camera', 182,000, 2, true, 3, 3, 0, 0 );
INSERT INTO product (code, name, brand, description, unit_price, quantity, is_active, category_id, supplier_id, purchases, views)
VALUES ('PRDPQR123WGTX', 'Google Pixel', 'google', '64gb Storage: 3gb ram: Snapdragon 802 octacore processor: 16.0MP Camera', 157,000, 5, true, 3, 2, 0, 0 );
INSERT INTO product (code, name, brand, description, unit_price, quantity, is_active, category_id, supplier_id, purchases, views)
VALUES ('PRDMNO123PQRX', ' Macbook Pro', 'apple', '256gb Storage: 8gb ram: Apple octacore processor: Nvidia Geforce 820', 354,000, 3, true, 1, 2, 0, 0 );
 INSERT INTO product (code, name, brand, description, unit_price, quantity, is_active, category_id, supplier_id, purchases, views)
VALUES ('PRDABCXYZDEFX', 'Dell Latitude E6510', 'dell', '500gb Storage: 8gb ram: intel corei7 processor: Nvidia Geforce 940mx', 248,000, 5, true, 1, 3, 0, 0 );

-- adding a supplier correspondece address
INSERT INTO address( user_id, address_line_one, address_line_two, city, state, country, postal_code, is_billing, is_shipping) 
VALUES (4, '102 Dawaiki Society, Appo Gandhi Road', 'Near Salt Lake, Utako', 'Maitama', 'Abuja', 'Nigeria', '111111', true, false );
